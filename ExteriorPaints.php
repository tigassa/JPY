...
$query = "SELECT pr_photo, pr_name, pr_description, pr_pdf FROM products WHERE pr_type = 'exterior'";
...
<body class="bg-gray-50">
    ...
    <main class="pt-24 pb-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold text-center text-gray-800 mb-12 mt-6">الدهانات الخارجية</h1>
